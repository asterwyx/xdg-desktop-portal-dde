...
// class TreeLandCaptureSession : public QObject, public QtWayland::treeland_capture_session_v1
// {
//     Q_OBJECT
// public:
//     TreeLandCaptureSession(struct ::treeland_capture_session_v1 *object)
//     : QObject()
